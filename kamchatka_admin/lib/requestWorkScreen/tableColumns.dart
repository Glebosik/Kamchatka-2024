...
void columnsGenerate(index) {
  ...
  tableColumns
      .add(DataColumn2(label: headerCell('Статус'), size: ColumnSize.M));
  tableColumns
      .add(DataColumn2(label: headerCell('Дата прибытия'), size: ColumnSize.L));
  tableColumns.add(
      DataColumn2(label: headerCell('Место прибытия'), size: ColumnSize.L));
}
