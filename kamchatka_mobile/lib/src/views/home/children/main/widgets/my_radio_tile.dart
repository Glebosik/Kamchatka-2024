...
class MyRadioListTile<T> extends StatelessWidget {
  ...
  ///
  /// All other properties are the same as [MyRadioListTile].
  const MyRadioListTile.adaptive({
    super.key,
    required this.value,
    required this.groupValue,
    required this.onChanged,
  ...
  /// If specified, [shape] defines the shape of the [MyRadioListTile]'s [InkWell] border.
  final ShapeBorder? shape;

  /// If specified, defines the background color for `RadioListTile` when
  /// [MyRadioListTile.selected] is false.
  final Color? tileColor;

  /// If non-null, defines the background color when [MyRadioListTile.selected] is true.
